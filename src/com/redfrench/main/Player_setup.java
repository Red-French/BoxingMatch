...
public class Player_setup {
	...
	int i;
	public static ArrayList<Fighter> getDuksters() {
		return duksters;
	}


	static ArrayList<Fighter> duksters = new ArrayList<Fighter>();
    ...
    public static void announcer(Fighter competitor) {
